                     ...
                     <td align="center">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td>
                                    <center>
                                    <strong><font size="5" >CHANNEL COLLABORATORS INVITATION</font></strong> 
                                    </center>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr  align="center">
                                <td>
                                    <font size="2"><strong>{{$owner_email }}</strong> invited you as a editor/colaborator<br>for the channel <strong>{{$channel_name}}</strong></font>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr align="center">
                                <td>
                                    <font size="2">Username: <strong>{{$user->email }}</strong></font>
                                </td>
                            </tr>
                            <tr align="center">
                                <td>
                                    <font size="2">Password: <strong>{{$password }}</strong></font>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a style="
                                        ...
                                        text-align: center;
                                        padding: 1rem 2rem;
                                    " href="{{ route('verifyCollabInvitationLink',['link' => $link ]) }}"><strong>Accept Invitation</strong></a>
                                    </center>
                                </td>
                            </tr>
                            <tr>
