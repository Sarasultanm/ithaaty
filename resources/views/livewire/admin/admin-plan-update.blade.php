      ...
      <main class="lg:col-span-12 xl:col-span-10">
        ...
        <div class="mt-4">
          <div class="mb-5 w-full ">
             <h1 class="font-bold text-gray-800 text-xl">Update Plan</h1> 
          </div>
          <div class="w-full ">
                                  ...
                                  <div class="col-span-2">
                                      <div class="relative flex items-start">
                                        <div class="flex items-center h-5">
                                          ...
                                          <input type="checkbox" {{$pf_typeOne}} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded"  wire:model="pf_typeOne" @click="on = !on">
                                   ...
                                   <div class="col-span-2">
                                      <div class="relative flex items-start">
                                        <div class="flex items-center h-5">
                                          <input type="checkbox" {{$pf_typeTwo}}  x-bind:disabled="on"  :class="{ 'cursor-not-allowed': on, '': !(on) }"   class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded " wire:model="pf_typeTwo" >
                                        </div>
                                        <div class="ml-3 text-sm">
              ...
              <div class="mt-3  sm:mt-5 mb-20">
                    <div class="w-full">
                        ...
                        <div class="w-1/2 float-left text-right">
                            <button wire:click="updatePlan({{$plan_id}})" type="submit" class="w-1/2 inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-custom-pink text-base font-medium text-white sm:col-start-2 sm:text-md">
                          Update
                            </button>
                        </div>
                      </div>    
