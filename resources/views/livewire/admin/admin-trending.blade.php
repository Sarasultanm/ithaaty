      ...
      <main class="lg:col-span-12 xl:col-span-10">
        ...
        <div class="mt-4">
          <div class="mb-5 w-full ">
          	 <h1 class="font-bold text-gray-800 text-xl">Trending</h1> 
          </div>
              ...
              <article aria-labelledby="question-title-81614">
                      ...
                      <p class="text-lg font-bold text-gray-900">
                       ...
                       <p class="text-sm text-gray-500">
                        <a href="#" class="hover:underline">
                          <time datetime="2020-12-09T11:43:00">{{ $audio->get_audio->audio_summary }}</time>
                        </a>
                      </p>
                    </div>
                  </div>
                ...
                <div class="mt-2 text-sm text-gray-700 space-y-4">
                   ...
                   <div class="text-white py-5 px-10 audio-bg-blur" style="background-image: url({{ asset('images/audio-bg.jpg') }});">
                    ...
                    <p class="text-white text-xs uppercase mt-5">
                       <img class="h-6 w-6 rounded-full float-left" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixqx=cZT0ApgKqn&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                       <p class="text-md font-bold ml-2 pl-6 pt-1">{{ $audio->get_audio->get_user->name }}</p>
