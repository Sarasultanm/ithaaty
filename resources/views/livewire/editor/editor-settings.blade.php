			    ...
			    <div class="w-full pt-4">
			      ...
			      <div x-show="openTab === 4">
			                  ...
			                  <div class="flex-grow space-y-6 ">
			                    <div>
			                      ...
			                      <div class="mt-1 rounded-md shadow-sm flex">
			                        <input type="text" class="focus:ring-sky-500 focus:border-sky-500 flex-grow block w-full min-w-0 rounded-none rounded-md sm:text-sm border-gray-300" wire:model="userName" >
			                      </div>
			                    </div>
				    ...
				    <section>
			          ...
			          <button wire:click="updateProfile()" type="submit" class="mt-5 bg-custom-pink border border-transparent rounded-md shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 float-right">Update</button>
