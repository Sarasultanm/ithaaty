<div class="pt-5 border-b-2 pb-10 border-green-500 ">  
...
<div x-data="{
       ...
       <div class="border-b border-gray-200">
           <ul class="-mb-px flex" >
             ...
             <li @click="openTab = 'image'" :class="openTab === 'image' ? activeClasses : inactiveClasses"  class="w-1/2 py-4 px-1 text-center border-b-2 font-medium text-sm cursor-pointer">
                <a>Image</a>
              </li>
           </ul>
       </div>
       ...
       <div  x-show="openTab === 'image'">
            ...
            <div class="mt-5">
                ...
                x-on:livewire-upload-progress="progress = $event.detail.progress">
                    ...
                    <div class="items-center mt-5">
                    <input id="push" name="notification-method" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 float-left"  value="image"  wire:model="adslist_videotype">
                    <label for="push" class="ml-5 block text-sm font-medium text-gray-700">
                        Agree for Image
                    </label>
                        @error('adslist_videotype') <span class="text-xs text-red-600">Please check this button</span> @enderror
...
<h1 class="flex-1 font-bold text-gray-800 text-xl ">Duration</h1> 
 ...
 <div class="mt-3 text-right sm:mt-5 mb-5 hidden">
