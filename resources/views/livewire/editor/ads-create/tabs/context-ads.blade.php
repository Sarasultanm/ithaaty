        ...
        <div class="col-span-2">
            ...
            <div class="flex p-1 mt-3 space-x-3 border-2 shadow-md">
                <div class="flex-shrink-0">
                    <img class="w-24 h-24 rounded-md" src="@if ($contextAdsImage)  {{ $contextAdsImage->temporaryUrl() }} @else {{ asset('images/default_user.jpg') }}  @endif" alt="" />
                </div>
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-gray-500 break-all font-regular">{{ $contextDescription }}</p>
                </div>
