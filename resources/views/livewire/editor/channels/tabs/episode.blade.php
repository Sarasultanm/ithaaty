...
<div  class="flex justify-between mb-5 space-x-3">
    ...
    <a target="_blank" href="{{ route('editorPodcastCreate') }}" class="inline-flex items-center font-bold cursor-pointer hover:underline hover-text-custom-pink text-md text-custom-pink">
