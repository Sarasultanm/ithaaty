        ...
        >
            ...
            >
                ...
                <div class="flex justify-between mt-5 space-x-3 sm:mt-6">
                    ...
                    <button wire:click="createPodcast({{$channel_list->id}})" type="button" class="inline-flex justify-center px-4 py-2 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-custom-pink">
                        Create Channel
                    </button>
                </div>
            </div>
