            ...
            @foreach($ads_list as $ads)
              ...
              <tr>
                ...
                <td class="px-6 py-4 text-sm text-center text-gray-500 whitespace-nowrap">
                  <a href="{{ route('editorAdsUpdate',['id' => $ads->id,'type'=>'context' ]) }}" target="_blank" class="text-indigo-600 hover:text-indigo-900">Update</a> / 
                    <a href="{{ route('editorAdsStats',['id' => $ads->id,'type'=>'context'  ]) }}" target="_blank" class="text-indigo-600 hover:text-indigo-900">Stats</a>
