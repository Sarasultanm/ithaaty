        ...
        <div class="col-span-2">
            ...
            <div class="p-3 mt-3 space-y-3 border-2 shadow-md">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <p class="text-xs text-gray-500 font-regular">{{ $adslist_desc }}</p>
                </div>
    
                <div class="flex-shrink-0">
                   
                    @if ($contextAdsImage)  
                        @php $ads_social_link = $contextAdsImage->temporaryUrl() @endphp
                    @else 
                        @php $ads_social_link = config('app.s3_public_link')."/ads/social_ads/".$ads_list->get_gallery->gallery_path ; @endphp
                    @endif
