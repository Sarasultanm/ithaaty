        ...
        <div class="">
         ...
         @else
            @if(Auth::user()->get_plan->check_features('p3')->count() != 0 || Auth::user()->get_plan->check_features('p2')->count() != 0 )
             ...
             <a href="{{ route('editorPodcastCreate') }}" class="w-full mb-5 text-center  px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white " style="background-color: #f98b88;">
                  New Post 
                </a>
              @endif
            @endif    
           ...
           @if( $audio->audio_status == 'public' || $audio->audio_editor == Auth::user()->id || $this->get_if_friends($audio->audio_editor) == "Friends") 
            ...
            <li class="bg-white px-4 py-6 shadow sm:p-6 sm:rounded-lg">
              ...
              <!-- new updates -->
                ...
                <div class="mt-2 text-sm text-gray-700 space-y-4 relative hidden">
