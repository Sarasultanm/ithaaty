       ...
       <div class="col-span-6 mb-6">
              <div>
                  ...
                  <div class="px-4 py-5 overflow-hidden bg-white rounded-lg shadow sm:p-6">
                      <dt class="font-bold text-gray-900 truncate text-md">Total Skip</dt>
                      <dt class="text-xs text-gray-500 font-regular ">Number of skip that your ad receives</dt>
                  ...
                  <div class="px-4 py-5 overflow-hidden rounded-lg shadow bg-custom-pink sm:p-6">
                      <dt class="font-bold text-white truncate text-md">Today View</dt>
                      <dt class="text-xs text-white truncate font-regular">Number of view this day</dt>
              ...
              <ul role="list" class="divide-y divide-gray-200 ">
                 @foreach($listTopCountryMediaAds as $country_items) 
                  <li class="flex py-4">
                      ...
                      <div class="ml-3">
                          <p class="mt-2 font-medium text-gray-900 text-md">{{ $country_items->ash_country }}</p>
                      </div>
                      <div class="ml-auto ">
