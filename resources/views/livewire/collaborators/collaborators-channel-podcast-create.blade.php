<x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Collaborators Channel Podcast Create ') }}</h2></x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <!-- main -->
                <main class="xl:col-span-10 lg:col-span-9">
                    <div class="mt-4">
                        <!--session -->
                        <div class="w-full "><x-auth-session-status-custom class="mb-4 mt-4" :status="session('status')" /></div>
                        <!--session -->
                            ...
                            <div>
                                ...
                                <div class="border-t-2 border-custom-pink ">
                                    ...
                                    <div class="mt-5" x-data="{ on: false }" >
                                            <div class="flex">
                                                <div class="flex-1">
                                                    <label for="about" class="text-sm font-medium text-gray-700 mr-2" 
                                                    :class="{ 'hidden': on, 'block': !(on) }">
                                                        Transcript
                                                    </label>
                                                </div>
                                                <div>
                                ...
                                <div x-data="{
                                    ...
                                    <div class="mt-10 border-b border-gray-200">
                                        <ul class="-mb-px flex" >
                                            <li @click="openTab = 1" :class="openTab === 1 ? activeClasses : inactiveClasses"   
                                                class="w-1/2 py-4 px-1 text-center border-b-2 font-medium text-sm cursor-pointer" >
                                                <a>Embed Code</a>
                                            </li>
                                            <li @click="openTab = 2" :class="openTab === 2 ? activeClasses : inactiveClasses"  
                                                class="w-1/2 py-4 px-1 text-center border-b-2 font-medium text-sm cursor-pointer">
                                                                ...
                                                                <div class="w-full">
                                                                    <div class="w-1/2 float-left">&nbsp;
                                                                        <div wire:loading wire:target="saveMedia"
                                                                            class="text-center text-custom-pink font-bold text-gray-800 text-sm">
