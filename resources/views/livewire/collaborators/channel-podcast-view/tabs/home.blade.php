<div x-data="{modal: false}" class="flex justify-between mb-5 space-x-3">
    ...
    <a target="_blank" href="{{ route('collaboratorsChannelPodcastCreate',['link' => $podcast_uniquelink ]) }}" class="inline-flex items-center font-bold cursor-pointer hover:underline hover-text-custom-pink text-md text-custom-pink">
