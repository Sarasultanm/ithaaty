    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
        ...
        <div class="flex items-center md:absolute md:right-0 md:inset-y-0 lg:hidden">
          <!-- Mobile menu button -->
          <button type="button" class="-mx-2 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-rose-500"  @click="header = !header">
            ...
            -->
            <svg class="block h-6 w-6" :class="{ 'hidden': header, 'block': !(header) }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            -->
            <svg class="hidden h-6 w-6" :class="{ 'block': header, 'hidden': !(header) }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
        ...
        <div class="max-w-3xl mx-auto px-4 flex items-center sm:px-6">
          ...
          <div class="flex-shrink-0">
            ...
            @else
              <?php $img_path = Auth::user()->get_profilephoto->first()->gallery_path; ?>
              <?php $s3_link = config('app.s3_public_link')."/users/profile_img/".$img_path; ?>
              <img class="h-10 w-10 rounded-full" src="{{ $s3_link }}" alt="">
            @endif
          </div>
          ...
          <div class="ml-auto flex-shrink-0 bg-white rounded-full p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500">
            @if(Auth::user()->plan == 'new' || Auth::user()->plan =="")
