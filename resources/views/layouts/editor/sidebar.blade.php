<nav aria-label="Sidebar" class="sticky divide-y divide-gray-300 top-4">
          <div class="pb-8 space-y-1">
            ...
            @if(Auth::user()->get_plan->check_features('s4')->count() != 0 )
             ...
             <x-nav-link-custom :href="route('editorFavorites')" :active="request()->routeIs('editorFavorites')">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
              </svg><span class="truncate">Favorites</span>
             </x-nav-link-custom>
              ...
              <p class="px-3 pt-5 text-xs font-semibold tracking-wider text-gray-500 uppercase" id="communities-headline">
               Podcast
                ...
                <x-nav-link-custom :href="route('editorPodcast')" :active="request()->routeIs('editorPodcast','editorPodcastUpdate','editorPodcastDetails')">
                  ...
                  <span class="truncate">Podcast</span>
                </x-nav-link-custom>
            ...
            @if(Auth::user()->plan == 'new' || Auth::user()->plan =="")
             ...
             @if(Auth::user()->get_plan->check_features('o10')->count() != 0 )
                ...
                <x-nav-link-custom :href="route('editorChannel')" :active="request()->routeIs('editorChannel')">
                  <!-- Heroicon name: outline/fire -->
                  <svg xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
