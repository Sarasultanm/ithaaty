...
class CollaboratorsChannelPodcastCreate extends Component
{   
    use WithFileUploads;
    ...
    public function mount(CollaboratorRepositories $collaborator,$link){
    ...
    public function saveMedia(){
        ...
        $data = new Audio;
        $data->audio_editor = $this->auth_collab->usercol_ownerid;
        ...
        redirect()->to('/collaborators/channel/podcast/'.$this->podcast_link);
    ...
    {   
        ...
        return view('livewire.collaborators.collaborators-channel-podcast-create',compact('categoryList'));
    }
}
